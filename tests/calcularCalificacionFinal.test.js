...
describe('calcularCalificacionFinal — Pruebas solicitadas', () => {
  ...
  test('5) Error: Ponderación Inválida -> -1.0', () => {
  ...
  test('6) Error: Calificación Fuera de Rango -> -1.0', () => {
    const n = calcularCalificacionFinal(11.0, 8.0, 8.0, 90, 0.3, 0.3, 0.4);
    expect(n).toBe(-1.0);
  });

  test('7) Caso Frontera Asistencia: 80% -> 10.0', () => {
